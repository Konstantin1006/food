...
function cards() {
  ...
  (0,_services_services__WEBPACK_IMPORTED_MODULE_0__["getResourсe"])(" http://localhost:3000/menu").then((data) => createCard(data));
...
window.addEventListener("DOMContentLoaded", () => {
  ...
  (0,_modules_timer__WEBPACK_IMPORTED_MODULE_6__["default"])(".timer", "2023-10-27");
});
